...
#
#-------------------------------------------------------------#
teleport @e[type=!player,type=!#tta:inedible,tag=tta.temp.eatingByFrogzilla,limit=8,sort=nearest,tag=!global.ingore] ~ ~-0.5 ~
...
execute if score @s monkeyhue.time1 matches 26..80 as @e[type=!#tta:inedible,type=!#tta:explosive,tag=!tta.temp.eatingByFrogzilla,distance=0..3,limit=1,tag=!tta.entity.hitbox,tag=!global.ingore,nbt=!{Invulnerable:1b}] run function tta:entity/monster/frogzilla2/event/tongue/catch
execute if score @s monkeyhue.time1 matches 26..80 as @e[type=#tta:explosive,tag=!tta.temp.eatingByFrogzilla,distance=0..5,limit=1,tag=!tta.entity.hitbox,tag=!global.ingore,nbt=!{Invulnerable:1b}] run function tta:entity/monster/frogzilla2/event/tongue/catch
