...
#execute as @e[type=!#tta:not_mobs,distance=0..1.5,limit=1,sort=nearest,tag=!tta.ignore,nbt=!{Invulnerable:1b}] run function tta:entity/projectile/eye_laser/projectile/hit_mob
