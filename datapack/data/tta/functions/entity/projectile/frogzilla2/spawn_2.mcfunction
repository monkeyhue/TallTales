...
execute as @e[type=armor_stand,distance=0..16,limit=1,sort=nearest,tag=tta.projectile.frogzilla2,tag=new] at @s run function tta:entity/projectile/frogzilla2/init_2