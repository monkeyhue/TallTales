...
execute if score @s monkeyhue.time5 matches 10 positioned ^ ^ ^3.5 as @e[type=!#tta:inedible,distance=0..3.5,tag=!tta.entity.hitbox,tag=!global.ignore,nbt=!{Invulnerable:1b},limit=5,sort=nearest] at @s run function tta:entity/monster/garlic_mutant/event/eat
