# Init
execute if entity @s[tag=tta.render.werewolf.brown] run data modify entity @s ArmorItems[3].tag.CustomModelData set value 6532063
execute if entity @s[tag=tta.render.werewolf.black] run data modify entity @s ArmorItems[3].tag.CustomModelData set value 6532083
execute if entity @s[tag=tta.render.werewolf.white] run data modify entity @s ArmorItems[3].tag.CustomModelData set value 6532103
