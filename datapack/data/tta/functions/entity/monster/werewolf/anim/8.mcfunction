# Init
execute if entity @s[tag=tta.render.werewolf.brown] run data modify entity @s ArmorItems[3].tag.CustomModelData set value 6532071
execute if entity @s[tag=tta.render.werewolf.black] run data modify entity @s ArmorItems[3].tag.CustomModelData set value 6532091
execute if entity @s[tag=tta.render.werewolf.white] run data modify entity @s ArmorItems[3].tag.CustomModelData set value 6532111
execute store result score %temp monkeyhue.temp1 run time query gametime
scoreboard players set %tta.animLength monkeyhue.temp1 17
