...
#
#-------------------------------------------------------------#
execute unless score @s monkeyhue.temp2 matches 11 run function tta:entity/monster/werewolf/anim/10
...
execute if score @s monkeyhue.time4 matches 60.. run scoreboard players set @s monkeyhue.entity.AIState 6