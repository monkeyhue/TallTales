...
#
#-------------------------------------------------------------#
execute unless score @s monkeyhue.temp2 matches 16 run function tta:entity/monster/werewolf/anim/15
execute unless score @s monkeyhue.temp2 matches 16 run scoreboard players reset @s monkeyhue.time4
...
execute if score @s monkeyhue.time4 matches 44.. run scoreboard players set @s monkeyhue.time5 60
execute if score @s monkeyhue.time4 matches 44.. run scoreboard players set @s monkeyhue.entity.AIState 6