...
execute if score @s monkeyhue.entity.AIState matches 10..11 at @s unless entity @e[distance=..200,type=!#tta:inedible,tag=tta.temp.frogzillaTargeted] run scoreboard players set @s monkeyhue.entity.AIState 0
