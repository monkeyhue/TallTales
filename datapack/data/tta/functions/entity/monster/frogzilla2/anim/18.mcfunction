# Init
data modify entity @s ArmorItems[3].tag.CustomModelData set value 6532013
execute store result score %temp monkeyhue.temp1 run time query gametime

scoreboard players set %tta.animLength monkeyhue.temp1 78
scoreboard players set %tta.animLeft monkeyhue.temp1 0
...
scoreboard players set @s monkeyhue.temp2 18