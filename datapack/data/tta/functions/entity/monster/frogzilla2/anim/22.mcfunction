# Init
data modify entity @s ArmorItems[3].tag.CustomModelData set value 6532018
execute store result score %temp monkeyhue.temp1 run time query gametime
scoreboard players set %tta.animLength monkeyhue.temp1 50
...
scoreboard players set @s monkeyhue.temp2 22