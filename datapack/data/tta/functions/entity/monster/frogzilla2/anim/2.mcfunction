# Init
data modify entity @s ArmorItems[3].tag.CustomModelData set value 6532004
execute store result score %temp monkeyhue.temp1 run time query gametime
scoreboard players set %tta.animLength monkeyhue.temp1 48
...
scoreboard players set @s monkeyhue.temp2 2