# Init
data modify entity @s ArmorItems[3].tag.CustomModelData set value 6532019
...
scoreboard players set %tta.animLeft monkeyhue.temp1 1
...
scoreboard players set @s monkeyhue.temp2 23