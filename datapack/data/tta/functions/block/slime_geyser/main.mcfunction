...
execute unless score @s monkeyhue.block.var3 matches 2.. if block ~ ~1 ~ #tta:airlike_with_liquid positioned ~ ~1 ~ if entity @e[type=!#tta:not_mobs_players,distance=..1,tag=!tta.ignore] positioned ~ ~-1 ~ run function tta:block/slime_geyser/event/erupt_pre