...
summon wither_skeleton ~ ~1 ~ {Silent:1b,Invulnerable:1b,NoAI:1b,PersistenceRequired:1b,Tags:["tta.entity_20t","smithed.entity","tta.ignore","smithed.strict","tta.entity","tta.render","tta.entity.hitbox","tta.entity.hitbox.garlic_mutant","tta.render.garlic_mutant"],ArmorItems:[{},{},{},{id:"minecraft:leather_horse_armor",Count:1b,tag:{CustomModelData:6532001}}],ActiveEffects:[{Id:14b,Amplifier:0b,Duration:1000000,ShowParticles:0b},{Id:13b,Amplifier:0b,Duration:1000000,ShowParticles:0b}],Leashed:1b,Health:1000f,Attributes:[{Name:generic.max_health,Base:1000}],Air:3000s}
