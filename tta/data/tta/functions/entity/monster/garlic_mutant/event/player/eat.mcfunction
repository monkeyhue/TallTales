#-------------------------------------------------------------#
#
# Deals damage when bitten by a Garlic Mutant
#
#-------------------------------------------------------------#

scoreboard players add @s smithed.damage 14
...
execute if entity @s[type=player] run scoreboard players set @s monkeyhue.player.deathMessageID 5
