#-------------------------------------------------------------#
#
# Controls an Oculuo Insomnius
#
#-------------------------------------------------------------#
execute unless score @s monkeyhue.temp2 matches 0 run function tta:entity/projectile/eye_laser_manic/anim/0
...
execute if score @s monkeyhue.time2 matches 20 if entity @e[distance=0..40,tag=!global.ignore,nbt=!{Invulnerable:1b},type=#tta:hostiles] run scoreboard players set @s monkeyhue.entity.AIState 1
