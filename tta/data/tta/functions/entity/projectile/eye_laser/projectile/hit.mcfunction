...
execute as @e[type=!#tta:not_mobs_players,distance=0..2.5,limit=3,sort=nearest,tag=!global.ignore,nbt=!{Invulnerable:1b}] at @s run function tta:entity/projectile/eye_laser/projectile/hit_mob
